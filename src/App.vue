  ...
  <div id="app" class="py-3">
    ...
    <main class="container">
      ...
      <section class="row justify-content-center g-3">
        <div class="col col-md-6 col-lg-4" v-for="producto in productos" :key="producto.id">
        <div class="card">
          ...
          productos: [
              {
                  ...
                  descripcionLarga: "Zapatillas modelo1, marca x"
              },
              {
                  id: 2,
                  nombre: "Producto 2",
                  ...
                  descripcionLarga: "Zapatillas modelo2, marca x"
              },
              {
                  id: 23,
                  nombre: "Producto 3",
                  ...
                  descripcionLarga: "Zapatillas modelo3, marca x"
              },
          ],
          currentProducto: {},
      };
